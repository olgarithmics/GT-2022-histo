...
for i in {0..4};
do CUDA_VISIBLE_DEVICES=0 python main.py --n_class 2 --data_path "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/rcc/"  --val_set "/home/ofourkioti/Projects/HistoTree/rcc_files/test_${i}.txt" --model_path "graph_transformer/saved_models/" --log_path "graph_transformer/runs/" --task_name "gtp_rcc_${i}" --batch_size 1 --test --log_interval_local 5  --resume "graph_transformer/saved_models/gtp_rcc_${i}.pth"
done