...
--train_set "/home/ofourkioti/Projects/HistoTree/rcc_files/train_${i}.txt"\
--val_set "/home/ofourkioti/Projects/HistoTree/rcc_files/val_${i}.txt"\
--model_path "graph_transformer/saved_models/" \
--log_path "graph_transformer/runs/" \
--task_name "gtp_rcc_${i}"\
--batch_size 4 \
--train \
--log_interval_local 5
done