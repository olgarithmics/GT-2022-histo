...
#SBATCH --output=/home/ofourkioti/Projects/GT-2022-histo/results/feats.out
...
python compute_feats_res.py --weights "DSMIL_extractors/camelyon/model-v0.pth"  --dataset "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/PDAC_TMA/patches/*" --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/PDAC_TMA/feats_pretrain_cam16/" --slide_dir /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/slides/PDAC_TMA/images/
