...
python compute_feats_gtp.py --weights "DSMIL_extractors/camelyon/model-v0.pth" --dataset "/home/admin_ofourkioti/PycharmProjects/baseline_models/tmi/rcc/patches/*"  --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/rcc/graphs" --slide_dir /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/slides/TCGA_RCC/
