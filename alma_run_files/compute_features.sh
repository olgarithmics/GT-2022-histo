...
#python compute_feats_dsmil.py --weights_low "TCGA_feature_extractor/weights-low-mag/" --batch_size 512 --weights_high "TCGA_feature_extractor/" --dataset "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/tcga_lung/magnification_5x/patches/*" --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/tcga_lung/low_high_feats/" --magnification tree --slide_dir /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/slides/TCGA_LUNG/TCGA_flat/
