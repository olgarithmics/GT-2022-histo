...
#python compute_feats_res.py --weights "runs/tcga_breast/checkpoints/brca_model.pth"  --dataset "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/brca/patches/*" --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/brca/feats/" --slide_dir /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/slides/TCGA_BRCA/

python compute_feats_gtp.py --weights "runs/tcga_breast/checkpoints/tcga_breast.pth"  --dataset "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/brca/patches/*" --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/brca/graphs" --slide_dir /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/slides/TCGA_BRCA/
#
