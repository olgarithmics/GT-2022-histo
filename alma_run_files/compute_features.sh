...
#python compute_feats_res.py --weights "TCGA_feature_extractor/model-v0.pth"  --dataset "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/lung/patches/*" --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/lung/feats/" --slide_dir /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/slides/TCGA_LUNG/TCGA_flat/
